...
import { Search, Sparkles, ChevronDown, Mic, LayoutGrid, GalleryHorizontalEnd, Sun, Moon, AudioLines } from 'lucide-react';
                ...
                <div className="flex items-center gap-2 sm:gap-4 shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                      <button 
                          ...
                          className="flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-zinc-900 dark:bg-zinc-100 dark:text-zinc-900 hover:bg-zinc-800 dark:hover:bg-zinc-200 text-white rounded-full text-xs sm:text-sm font-medium shadow-md transition-all hover:scale-105 active:scale-95 group shrink-0"
                      >
                          <Sparkles size={14} className="text-indigo-300 dark:text-indigo-600 group-hover:text-indigo-200 transition-colors" />
                          <span className="tracking-wide hidden sm:inline">AI Casting</span>
                          <span className="tracking-wide sm:hidden">Casting</span>
                      </button>

                      <button 
                          onClick={onOpenTtsTool}
                          className="flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-full text-xs sm:text-sm font-medium shadow-md transition-all hover:scale-105 active:scale-95 group shrink-0"
                      >
                          <AudioLines size={14} className="text-indigo-100" />
                          <span className="tracking-wide hidden sm:inline">TTS Studio</span>
